 ...
 * @returns {number}
 */
export function calculate_liquidation_price(entry_price, leverage, position_type) {
    const ptr0 = passStringToWasm0(position_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_liquidation_price(entry_price, leverage, ptr0, len0);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('trading_sim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
